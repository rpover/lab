...
insert INTO reader (name, surname, phone, address)
VALUES ('Богдан', 'Иванов', 88883467170,'Москва');
insert INTO reader (name, surname, phone, address)
VALUES ('Борис', 'Столяров', 88883467171,'Москва');
insert INTO reader (name, surname, phone, address)
VALUES ('Надежда', 'Кудряшова', 88883467172,'Волгоград');
insert INTO reader (name, surname, phone, address)
VALUES ('Богдан', 'Козлов', 88883467173,'Краснодар');
